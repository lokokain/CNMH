...
class ArchivosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create archivo" do
    assert_difference('Archivo.count') do
      post archivos_url, params: { archivo: { descripcion: @archivo.descripcion, idinforme: @archivo.idinforme, title: @archivo.title } }
    end
  ...
  test "should update archivo" do
    patch archivo_url(@archivo), params: { archivo: { descripcion: @archivo.descripcion, idinforme: @archivo.idinforme, title: @archivo.title } }
