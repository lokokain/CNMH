class SessionsController < ApplicationController
	def create
		...
		flash[:alert] = "Puede que tengamos un problema con tus datos"
	...
	def destroy
		session[:user_id] = nil
		flash[:notice] = "Cierre de sesion Completo"
		redirect_to "/"
	end
